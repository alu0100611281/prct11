...
describe Mygem::Matriz_Densa do
    ...
    before :each do
        @m1 = Mygem::Matriz_Densa.new(2,2)
        @m2 = Mygem::Matriz_Densa.new(2,2)
...
describe Mygem::Matriz_Dispersa do

    before :each do
        @m1 = Mygem::Matriz_Densa.new(3,2)
        ...
        @md1 = Mygem::Matriz_Dispersa.copy(@m1)
        @md2 = Mygem::Matriz_Dispersa.new(3,2)
    end

    describe " # Almacenamiento de matrices. " do

        it " # Debe poderse crear matrices dispersas vacias o a partir de matrices densas." do
            Mygem::Matriz_Dispersa.new(5, 5)
            Mygem::Matriz_Dispersa.copy(@m1)
        end
    ...
    describe " # Operaciones con matrices dispersas. " do
        it " # Debe poderse sumar dos matrices " do
                @md3 = Mygem::Matriz_Dispersa.new(3,2)
        ...
        it " # Debe poderse multiplicar dos matrices " do
                @md4 = Mygem::Matriz_Dispersa.new(2,3)
                @md4.set(1,0,-1)
                @md4.set(1,1,-1)
                @md4.set(1,2,0)

                @md3 = Mygem::Matriz_Dispersa.new(3,3)
                @md3.set(0,0,0)
                @md3.set(0,1,0)
                @md3.set(0,2,0)
